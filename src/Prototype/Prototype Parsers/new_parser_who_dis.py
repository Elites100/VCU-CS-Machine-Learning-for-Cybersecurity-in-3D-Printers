...
def read_gcode_file(input_file_path, output_file_path):
    ...
    with open(input_file_path, 'r') as input_file, open(output_file_path, 'w', newline='') as output_file:
        ...
        csv_writer.writerow(['Ultimaker Version', 'Layer', 'Fan on/off', 'Fan speed (min)', 'Fan speed (max)', 'Fan speed (avg)',
                             ...
                             'Feedrate (min)', 'Feedrate (max)', 'Feedrate (avg)', 'Layer height'])
        ...
        for line in input_file:
            ...
            if line.startswith(';'):
                if line.startswith(';LAYER:'):
                    ...
                    if layer_0_found:
                        process_layer_data(ultimaker_version, layer, fan_on, temperature_values, fan_speed, feedrate_values, current_height, csv_writer)
...
def process_layer_data(ultimaker_version, layer, fan_on, temperature_values, fan_speed, feedrate_values, current_height, csv_writer):
    """
    ...
    if layer != '0':   
        csv_writer.writerow(['', layer, fan_on, min_fan_speed, max_fan_speed, avg_fan_speed,
