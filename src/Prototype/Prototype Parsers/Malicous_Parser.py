...
def main():
    ...
    for csv_file in csv_files:
        ...
        print("\nLines that will be changed:")
        display_data(rows_to_change)

        confirm = input("\nDo you want to proceed with the changes? (yes/no): ")
        ...
        next_file = input("\nDo you want to modify another file? (yes/no): ")
        if next_file.lower() != 'yes':
            break
