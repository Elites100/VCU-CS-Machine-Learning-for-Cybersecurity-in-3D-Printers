...
def read_gcode_file(input_file_path, output_file_path):
    with open(input_file_path, 'r') as input_file, open(output_file_path, 'w', newline='') as output_file:
        ...
        # Write Header
        header = ['Layer', 'Fan on/off', 'Fan speed', 'Temperature', 'Extrusion Mode', 'Feedreate', 'Layer height', 'Regex', 'Modified']
        ...
        for line in input_file:
            ...
            for idx, pattern in enumerate(KNOWN_COMMAND_PATTERNS, start=1):
                if re.match(pattern, line):
                    ...
                    break
            if not matched:
                csv_writer.writerow([layer, fan_on, fan_speed, temperature, extrusion_mode, feedrate, current_height, regex_number, '0'])
                continue
...
if __name__ == "__main__":
    input_file_path = r'C:\Users\mabro\Desktop\Spring 2024\AI\parsers\two_files\BAD.gcode'
    output_file_path = r'C:\Users\mabro\Desktop\Spring 2024\AI\parsers\two_files\BAD.csv'
