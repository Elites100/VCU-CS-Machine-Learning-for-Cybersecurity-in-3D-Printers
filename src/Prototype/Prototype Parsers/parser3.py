...
def read_gcode_file(input_file_path, output_file_path):
    with open(input_file_path, 'r') as input_file, open(output_file_path, 'w', newline='') as output_file:
        ...
        # Write Header
        header = ['Layer', 'Fan on/off', 'Fan speed', 'Change - Fan speed', 'Temperature', 'Temperature Change', 'Extrusion Mode', 'Unknown Commands', 'Regex', 'Modified']
        ...
        for line in input_file:
            ...
            csv_writer.writerow([layer, fan_on, fan_speed, '', temperature, temperature_change, extrusion_mode, unknown_command_line, regex_number, '0'])
